#code written by Beta Programmer
...
sroot.title("Hotel Management System")
...
#chilanka
Label(sroot,text="Hotel Management System ",font='Timesnewroman 36 ',bg='white',fg='black').place(x=535,y=10)
...
def mainroot():
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Beta Programmer",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
